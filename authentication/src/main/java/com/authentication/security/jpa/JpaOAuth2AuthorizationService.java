package com.authentication.security.jpa;
...
import com.authentication.domain.oauth.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService{
	...
	private Authorization toEntity(OAuth2Authorization authorization) {
		...
		//entity.setIdUsuario(((ResourceOwner)authentication.getPrincipal()).getId());
